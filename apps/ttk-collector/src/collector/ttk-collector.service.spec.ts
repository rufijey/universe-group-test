...
describe("TtkCollectorService", () => {
  ...
  it("should fail validation for an invalid TikTok event", async () => {
    const invalidEvent: Event = {
      ...validTiktokEvent,
      data: {
        ...validTiktokEvent.data,
        engagement: {
          ...validTiktokEvent.data.engagement,
          device: "SmartFridge" as any,
        },
      },
    };

    await service["handleTiktokEvent"](invalidEvent, "cid-104");
